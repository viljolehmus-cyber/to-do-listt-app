 ...
 * Tyyli: Lucide / Phosphor, 24×24 viewport, 1.75px viiva, pyöristetty
 * Käyttö: icon('plus') → SVG-merkkijono
 *         icon('plus', 18, 'btn-icon') → pienennettynä + CSS-luokalla
 */
...
const PATHS = {
  ...
  list:         `<line x1="9" y1="6" x2="20" y2="6"/><line x1="9" y1="12" x2="20" y2="12"/><line x1="9" y1="18" x2="20" y2="18"/><circle cx="4" cy="6" r="1.5" fill="currentColor" stroke="none"/><circle cx="4" cy="12" r="1.5" fill="currentColor" stroke="none"/><circle cx="4" cy="18" r="1.5" fill="currentColor" stroke="none"/>`,
  ...
  undo:   `<polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-3.08"/>`,
  ...
  'cloud-off':     `<path d="M22.61 16.95A5 5 0 0 0 18 10h-1.26A8 8 0 0 0 5 5.05"/><path d="M18 18.72a4.98 4.98 0 0 1-1.06.28H9a5 5 0 0 1-1-9.9"/><line x1="1" y1="1" x2="23" y2="23"/>`,
...
export function icon(name, size = 20, cls = '') {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${SW}" stroke-linecap="round" stroke-linejoin="round"${classAttr} aria-hidden="true">${paths}</svg>`;
}
